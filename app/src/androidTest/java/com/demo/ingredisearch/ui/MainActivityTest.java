...
//        scenario.close();
    ...
    public void testCloseDrawer() {
        ...
        onView(withId(R.id.mainFragment)).check(matches(not(isDisplayed())));
        onView(withId(R.id.searchFragment)).check(matches(not(isDisplayed())));
        onView(withId(R.id.favoritesFragment)).check(matches(not(isDisplayed())));
    }
...
//        )).check(matches(isDisplayed()));
        ...
        onView(allOf(
                withId(R.id.noresultsTitle),
                withText(R.string.nofavorites),
                withParent(withId(R.id.noresultsContainer))
        )).check(matches(isDisplayed()));
    }
...
//        Espresso.pressBack();
    ...
    public void navigateToSearchScreenToSearchResults_and_backToMainScreen() {
        ...
        // ... check search results in view (omitted ...)
